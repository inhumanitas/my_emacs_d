...
;;   Rule Name            RegExp                          Opening Rule         Closing Rule       Offset   Subsequent Offset  Is Statement?
  '((xbase-if             "^[\t ]*if"                     nil                  xbase-endif        nil      nil                t)
    ...
    (xbase-do_while       "^[\t ]*do_while"   nil                  xbase-enddo        nil      nil                t)
    (xbase-while       "^[\t ]*while"   nil                  xbase-enddo        nil      nil                t)
    (xbase-end_do          "^[\t ]*enddo"                  xbase-do_while       nil                nil      nil                t)
    (xbase-enddo          "^[\t ]*enddo"                  xbase-do-while       nil                nil      nil                t)
    (xbase-enddo-while          "^[\t ]*enddo"                  xbase-while       nil                nil      nil                t)
...
(defcustom xbase-font-lock-statements
  '("announce"
    ...
    "do while" "exit" "loop" "enddo"
    "do_while" "exit" "loop" "enddo"
    "procedure"
